...
class ViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    var imageArray = [UIImage(named: "02-News detalise_dark-3"),UIImage(named: "02-News detalise_dark-3"),UIImage(named: "02-News detalise_dark-3"),UIImage(named: "02-News detalise_dark-3")]
